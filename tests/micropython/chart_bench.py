...
def main():
    ...
    bench('segmented area (300px)',
          lambda: asyncio.run(chart.draw_segmented_area(display, 10, 10, 300, 100, RAW, VALUES_Q8, color_fn)))
    bench('colored points (300px)',
          lambda: asyncio.run(chart.draw_colored_points(display, 10, 10, 300, 100, RAW, VALUES_Q8, color_fn, radius=2)))
