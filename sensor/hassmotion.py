...
class HassMotion:
    def __init__(self, hass, pin, friendly_name, sensor):
        self.hass = hass
    ...
    def create(provider):
        ...
        return HassMotion(provider['hass.Hass'], config['pin'], config['friendly_name'], config['sensor'])
        ...
        while True:
            ...
            try:
                while True:
                    ...
                    await asyncio.wait_for(self.tsf.wait(), 300)
