...
import uctypes
import micropython
from mipidcs import _rgb565_to_888_line, _rgb332_to_888_line
...
class AsyncSpiDriver:
    ...
    def _loop(self):
        ...
        while self._stop[0] == 0:
            ...
            if sc == 1 and bpp == 3:
                if cm == 'RGB332':
                    core1_spi_push332_888(*push_args)
                else:
                    core1_spi_push565_888(*push_args)
            else:
                disp.render(fb, w, h, (0, 0, w, h))
