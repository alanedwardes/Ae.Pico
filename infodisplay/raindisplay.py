...
class RainDisplay:
    ...
    async def update(self):
        ...
        # Draw key labels
        white_pen = 0xFFFFFF
        textbox.draw_textbox(self.display, 't', 0, hour_row_y, key_width, row_height, color=white_pen, font=font_name)
        textbox.draw_textbox(self.display, 'mm', 0, precip_row_y, key_width, row_height, color=white_pen, font=font_name)
        textbox.draw_textbox(self.display, '%', 0, chart_y, key_width, chart_height, color=white_pen, font=font_name)
        textbox.draw_textbox(self.display, 'Bft', 0, wind_row_y, key_width, row_height, color=white_pen, font=font_name)
        ...
        for i in range(num_points):
            ...
            # Hour numbers
            textbox.draw_textbox(self.display, f'{hour_number}', sx, hour_row_y, column_width, row_height, color=white_pen, font=font_name)
            ...
            textbox.draw_textbox(self.display, str(rate_int), sx, precip_row_y, column_width, row_height, color=precip_color, font=font_name)
            ...
            textbox.draw_textbox(self.display, f"{beaufort_number}", sx, wind_row_y, column_width, row_height, color=beaufort_color, font=font_name)
